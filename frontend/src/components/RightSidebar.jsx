...
/* example usage
<div className="grid grid-cols-1 md:grid-cols-12 gap-6 max-w-7xl mx-auto px-6">
  <main className="md:col-span-7 lg:col-span-8">{/* feed */}</main>
  <RightSidebar trending={mockTrending} suggestions={mockSuggestions} loading={false} />
</div>
*/
